      ...
      <div className="card-body">
        {isLoading ? (
          <div className="space-y-4" role="status" aria-live="polite">
            ...
            <div className="animate-pulse">
              <div className="h-4 bg-secondary-200 rounded w-1/5 mb-2"></div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-secondary-900">{analysis.suggestedTitle}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-secondary-900">{analysis.description}</p>
            </div>
